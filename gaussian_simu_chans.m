...
for i= pn:pn % parameters   
    ...
    for j = 1:run % run, 5-th run is appropriate to display in articles
        ...
        [meg,noise] = add_gaussian_noise(clean,snr);
        ...
        constrs = perform_six_methods(meg(chanindex,:),normlf(chanindex,:),lf(chanindex,:));
