function [ent,svd_cor,cov_cor] = compute_entro_svd_cov(A,B)
maxentropy = 17.0479; % log2(271 * 500)
ent = (maxentropy - compute_entropy(A)) ./ (maxentropy - compute_entropy(B));
